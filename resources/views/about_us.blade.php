...
@section('content')
  ...
  <main id="main" class="mt-5">
    ...
    <section id="blog" class="blog">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row feture-tabs" data-aos="fade-up">
          <div class="col-lg-9">
            <h3>Neque officiis dolore maiores et exercitationem </h3>
    ...
    <!-- ======= Team Section ======= -->
    <section id="key_features" class="team">
    ...
    <!-- ======= Features Section ======= -->
    <section id="mission_and_vision" class="features">
  ...
  <!-- ======= Products Section ======= -->
  <section id="achievements" class="portfolio">
