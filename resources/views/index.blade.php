...
@section('content')
  ...
  <main id="main">
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-toggle="modal" data-target="#myModal" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
                <img src="images/moin682tokai.jpg" class="img-fluid" alt="">
              <h3>POWER STATION</h3>
              <p>This is for information of all concerned that M/S Tokai Power Products Ltd. has the following tea...</p>
            </div>
          </div>

          <div class="col-lg-4 mt-4 mt-lg-0" data-toggle="modal" data-target="#myModal" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              <img src="images/moin690tokai.jpg" class="img-fluid" alt="">
              <h3>ELECTRIC LIFT</h3>
              <p>This is for information of all concerned that M/S Tokai Power Products Ltd. has the following tea... </p>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-toggle="modal" data-target="#myModal" data-aos="fade-up" data-aos-delay="600">
            <div class="box">
              <img src="images/moin736tokai.jpg" class="img-fluid" alt="">
              <h3>INDUSTRIAL, COMMERCIAL, RESIDENTIAL ELECTRIC</h3>
              <p>This is for information of all concerned that M/S Tokai Power Products Ltd. has the following tea...</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-toggle="modal" data-target="#myModal" data-aos="fade-up" data-aos-delay="600">
            <div class="box">
              <img src="images/moin808tokai.jpg" class="img-fluid" alt="">
              <h3>REWIRING & UPGRADING ELECTRIC WORKS.</h3>
              <p>This is for information of all concerned that M/S Tokai Power Products Ltd. has the following tea... </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-toggle="modal" data-target="#myModal" data-aos="fade-up" data-aos-delay="600">
            <div class="box">
              <img src="images/moin893tokai.jpg" class="img-fluid" alt="">
              <h3>KWH/ ENERGY METER, TURNKEY PROJECTS</h3>
              <p>This is for information of all concerned that M/S Tokai Power Products Ltd. has the following tea...</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="clients/aci.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/akij.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/akij_group.png" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/akij_ciment.png" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/amg.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/asian_paint.png" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/ban_railway.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/bbs_cables.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/concord.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/fitted.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/islami_bank.png" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/keya.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/metrocem.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/pepsi.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/runner.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
            <div class="swiper-slide"><img src="clients/square.jpg" class="img-fluid max-width: 100%; height: auto;" alt=""></div>
          </div>
    ...
    <!-- ======= Sales Section ======= -->
    <section id="sales_centers" class="sales_centers">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <div class="member-img">
                <img src="images/team/moin682tokai.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="member-img">
                <img src="images/team/moin686tokai.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="member-img">
                <img src="images/team/moin745tokai.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="400">
            <div class="member">
              <div class="member-img">
                <img src="images/team/moin898tokai.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">POWER STATION</h4>
